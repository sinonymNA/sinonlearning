...
export default function GlobePage() {
  ...
  return (
    <div
      className="relative w-screen overflow-hidden bg-[#060e1a]"
      style={{ height: "100dvh" }}
    >
      {/* Back link */}
      ...
      <div className="absolute top-4 left-4 z-20 pointer-events-none">
        <h1 className="text-white text-sm font-semibold tracking-wide opacity-60 select-none">
          Historical Globe
        </h1>
      </div>
      ...
      <div className="absolute top-14 left-4 z-20 pointer-events-none">
        <div className="flex flex-col gap-1.5">
          {[
            { color: "#1e3a5f", label: "Sovereign State" },
