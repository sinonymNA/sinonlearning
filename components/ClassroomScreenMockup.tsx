...
export default function ClassroomScreenMockup() {
  return (
    <motion.div
      ...
      className="rounded-[28px] border border-navy-900/10 bg-navy-950 p-4 shadow-[0_30px_60px_-15px_rgba(13,27,46,0.3)] sm:p-6"
    >
      <div className="mb-4 flex items-center justify-between px-1">
        <span className="text-xs font-medium uppercase tracking-wide text-cream-200/50">
          Classroom Screen
        </span>
        <span className="text-xs font-medium text-teal-300">Period 3 · Economics</span>
      </div>
