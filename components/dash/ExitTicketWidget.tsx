    ...
    <div className="w-64">
      {editing ? (
        ...
        <button
          ...
          className="w-full rounded-xl border border-dashed border-navy-900/15 bg-cream-50 px-4 py-6 text-center font-display text-lg leading-snug text-navy-900 transition-colors hover:border-green-500/40"
        >
          {prompt}
        </button>
      )}
