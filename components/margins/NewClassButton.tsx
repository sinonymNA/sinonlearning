  ...
  if (!open) {
    return (
      <button
        ...
        className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-br from-rose-500 to-rose-700 px-4 py-2.5 text-sm font-semibold text-white shadow-sm shadow-rose-200 hover:shadow-md transition-all"
      >
        <Plus size={14} />
        New class
      </button>
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-rose-700 transition-colors disabled:opacity-60"
      >
        {loading ? "…" : "Create"}
      </button>
      <button
