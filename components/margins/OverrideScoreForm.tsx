    ...
    <form onSubmit={handleSubmit} className="rounded-2xl border border-stone-200 bg-white p-5 flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-20 rounded-lg border border-stone-200 bg-stone-50 px-2.5 py-1.5 text-sm text-center outline-none focus:border-violet-400"
        />
      ...
      <button
        ...
        type="submit"
        disabled={loading}
        className="self-start rounded-lg bg-violet-600 px-4 py-2 text-xs font-semibold text-white hover:bg-violet-700 transition-colors disabled:opacity-60"
      >
