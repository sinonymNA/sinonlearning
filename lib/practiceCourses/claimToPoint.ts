...
// type system this content is authored against.
    ...
    pages: [
      {
        ...
        body: [
          ...
          "Except she didn't show up to first period Monday. Or second. By lunch, her mom had called the school. By the end of the day, half of Ferryhollow High had a theory, and none of them had actually talked to each other about it.",
          "You're going to be the one who actually investigates this properly — piecing together claims, evidence, and reasoning until you've got something you could actually defend. Consider this your first case file.",
        ],
      },
      {
        id: "vanish-p2",
        ...
        body: [
          'Devon, texting the group chat Sunday night: "ok not to be dramatic but I think something actually happened to her." Priya, same group chat: "Devon is being SO weird about this and I don\'t know why." Jonah, to basically anyone who\'ll listen: "I mean... people vanish for their own reasons sometimes. I\'m not saying anything. I\'m just saying."',
          "Notice something? All three of those are just vibes. \"Something happened.\" \"Devon is being weird.\" \"People vanish for their own reasons.\" Not one of them actually commits to anything. They're all just gesturing in a direction without ever landing anywhere.",
          "That's the very first skill you need before any of this investigation goes anywhere: the difference between an actual claim and a vibe.",
        ],
      },
      {
        id: "vanish-p3",
        ...
        body: [
          "A claim is a sentence that could be WRONG. That's the test. If there's no way anyone could ever prove your sentence false, it's not a claim — it's just noise that sounds like an opinion.",
          '"Something happened to her" can never be wrong. It\'s compatible with literally every possible explanation, which means it doesn\'t actually say anything. But "I think Priya knows more than she\'s telling people" — that COULD be wrong. It commits to something. It takes a side. That\'s a claim.',
          "Here's the part that trips people up: a claim doesn't need proof yet to count as a claim. It just needs to actually say something specific enough that it could be false. Proof is a separate step — you'll get to that next. Right now, the only question is: did you actually commit to a side, or are you just hovering above the conversation being vague on purpose so you can't be wrong?",
        ],
      },
      {
        id: "vanish-p4",
        ...
        body: [
          'Quick gut check Scout runs on every claim: could you swap out the subject and the sentence would still basically work? "Something\'s off" works for literally any mystery ever told. "Priya\'s been avoiding eye contact with Devon since Saturday" only works for THIS one — it names a specific person, a specific behavior, a specific timeframe. That specificity is what makes it a real claim instead of atmosphere.',
    ...
    pages: [
      {
        ...
        body: [
          '"I left the bonfire around 10:30 and went straight home. I was asleep by 11. I didn\'t see anything after the fight started, I was already gone." That\'s what Devon told three different people this week, word for word each time — which is either because it\'s true, or because it\'s memorized.',
          "Except: Priya's older cousin works the counter at the 24-hour diner downtown — a solid fifteen-minute drive from Ferryhollow Point, in the opposite direction from Devon's house. And she swears Devon's phone number is the one that popped up on the diner's order pickup screen at 11:04pm Friday night. Downtown. Not home. Not asleep.",
        ],
      },
      {
        id: "alibi-p2",
        ...
        body: [
          'Last module you learned to spot a real claim. Now: a claim by itself is still just an accusation. "Devon\'s lying" is a real claim — it could be false — but it\'s floating with nothing under it. The next move is attaching ONE specific, concrete piece of evidence that actually supports it.',
      ...
      },
      {
        ...
        body: [
          "Here's the whole move in one place: Weak — \"I think Devon's hiding something.\" (A claim, but no evidence attached — it's an accusation floating in midair.) Strong — \"I think Devon's hiding something, because her number was logged at a downtown diner at 11:04pm, not at home like she claims.\" Same claim. One specific detail turns it from an accusation into something you could actually defend in front of someone who doesn't already believe you.",
          "Your job next: take a vague version of this exact claim and rebuild it with the one specific detail from the story that actually proves it.",
        ],
      },
      {
        id: "alibi-check",
      ...
      },
      {
        ...
        body: [
          "Same exact skill — claim, plus one specific detail that actually backs it up — except this time it's aimed at something real that actually happened, a couple hundred years ago, not a diner receipt.",
          "In 1791, King Louis XVI of France tried to secretly flee Paris in disguise with his family, hoping to reach royalist troops near the eastern border and escape the Revolution entirely. His \"alibi,\" more or less, was that this was all a normal, unremarkable trip. It fell apart in the town of Varennes when a local postmaster recognized the king's face — because it was printed on the paper currency everyone in France carried around in their pocket. Same shape as Devon's alibi: a cover story, and one specific, checkable detail that blew it apart.",
        ],
      },
      {
        id: "alibi-echo-check",
    ...
    pages: [
      {
        ...
        body: [
          "Turns out Devon's diner trip was nothing — she panic-drove to get fries after the fight because she was too upset to go straight home, then lied about the timing because she didn't want to admit how shaken up she was. Dead end. Sorry.",
          'But here\'s what came out this week: Priya told everyone the fight was "about nothing, just a dumb misunderstanding." Except Jonah finally admitted — reluctantly, and only after being asked directly twice — that the fight was actually about Marisol finding out Priya had been talking to Marisol\'s ex behind her back for weeks. That\'s not nothing. That\'s a real motive Priya has been actively hiding since Friday.',
        ],
      },
      {
        id: "betrayal-p2",
        ...
        body: [
          "You've now got two moves down: a real claim, and a claim backed by one specific piece of evidence. Here's the piece almost everyone skips, and it's the single biggest point-loser on a real SAQ: reasoning — the sentence that actually explains WHY your evidence proves your claim, instead of just restating the evidence in different words.",
          'Watch the trap: "Priya lied about the fight, because she told everyone it was about nothing when it was actually about her talking to Marisol\'s ex." That sentence is 100% just... the evidence again, worded slightly differently. It never actually explains WHY that evidence matters — it just repeats it.',
        ],
      },
      {
        id: "betrayal-p3",
        ...
        body: [
          'Reasoning has to add something the evidence alone didn\'t already say. Try this: "...because someone who was telling the truth about an argument being \'nothing\' wouldn\'t have a hidden reason to keep the real subject secret for four days — the fact that Priya buried the actual topic that long means she knew it made her look bad." That sentence does something new: it explains the LOGIC connecting the evidence to the claim, instead of just repeating the evidence.',
          "Today, you're not writing a claim or finding evidence — those are already done for you, on purpose. You're only writing the reasoning sentence. Isolating it like this is the whole point: it's the hardest of the three moves, so you're going to drill it completely alone before ever combining it with the other two again.",
        ],
      },
      {
        id: "betrayal-p4",
        ...
        prompts: [
          {
            ...
            givenContext:
              "Claim: Priya has been hiding her real motive since Friday. Evidence: Priya told the group the fight was \"about nothing,\" but Jonah confirmed it was actually about Priya secretly talking to Marisol's ex for weeks.",
            prompt:
          ...
          },
          {
            ...
            givenContext:
              "Claim: Jonah only admitted the truth because he was cornered, not because he wanted to come clean. Evidence: Jonah had already denied knowing the real reason for the fight twice, and only told the truth on the third direct question.",
            prompt:
      ...
      },
      {
        ...
        body: [
          "This time, no training wheels — full claim, evidence, AND reasoning, all in one, aimed at something real: a trusted ally with a hidden motive.",
          "In 44 BCE, Brutus — a Roman senator Julius Caesar personally trusted and had spared after a civil war — joined a group of senators who assassinated Caesar in the Senate. Publicly, the conspirators claimed they acted to save the Roman Republic from a would-be king. Privately, many of them, Brutus included, had their own resentments and ambitions tied up in Caesar's growing personal power. Same shape as Priya: a trusted insider, a motive that wasn't the one being said out loud.",
        ],
      },
      {
    ...
    pages: [
      {
        ...
        body: [
          "Marisol's older sibling flew back into town this week — first time in over a year — and has been asking everyone, very directly, what actually happened Friday night. That's added a whole different kind of pressure to all of this. It's not just group-chat curiosity anymore; there's someone who actually needs a real answer.",
          "Which is a good moment to notice something: you've now got all three moves — claim, evidence, reasoning — and you've been using them on a mystery this whole time because a mystery is genuinely just easier to care about than a textbook. But here's the thing Scout wants you to sit with for a second: the moves themselves were never actually about Marisol. They're the exact same moves historians use, on real, documentable events that actually happened.",
        ],
      },
      {
        id: "bridge-p2",
        ...
        body: [
          "So here's a real one, and it deserves the same energy as the Ferryhollow gossip: in 1324, Mansa Musa — the ruler of the Mali Empire, in West Africa — set out on a pilgrimage to Mecca. He didn't travel light. Estimates vary, but he brought a caravan that may have included thousands of soldiers, attendants, and enslaved people, along with an enormous quantity of gold.",
          "When he passed through Cairo, he gave away — reportedly just gave away — so much gold that he single-handedly crashed the local gold market. Prices took roughly a decade to fully recover. This wasn't an accident or a rumor that got exaggerated — it's documented by multiple contemporary Arab historians who were writing at the time, stunned by what they were watching.",
          "Notice the shape: someone with something to prove (or something they didn't even realize they were revealing), acting in a way that gave away way more than they probably meant to. Sound familiar? That's the exact same shape as Priya's secret finally coming out.",
        ],
      },
      {
        id: "bridge-p3",
        ...
        body: [
          "Here's the actual prompt you're about to answer: \"How did Mansa Musa's pilgrimage reveal Mali's wealth and political power?\" Break it down exactly like you've been doing all along: your CLAIM is what the pilgrimage actually revealed. Your EVIDENCE is one specific, checkable detail — a real number, a real place, a real named source. Your REASONING is the sentence explaining WHY that detail actually proves your claim, not just restating it.",
          "This is the real thing now — full claim, evidence, reasoning, all three, on genuine AP World content. Scout's grading this one exactly the way a real AP reader would. Same gossip energy, real stakes.",
        ],
      },
      {
        id: "bridge-check",
    ...
    pages: [
      {
        ...
        body: [
          "Devon says she heard Marisol mention \"needing space for a while\" earlier that night, before the fight even started. Jonah says he never heard that — and he was standing closer to Marisol than Devon was most of the night. Either one of them misremembered a chaotic night, or one of them is protecting someone by leaving something out. Hard to say yet.",
          "And then there's Wren — someone who wasn't even at the bonfire, but who'd been texting Marisol on and off that whole week. Nobody's talked to Wren directly; everything anyone knows about those texts comes secondhand, through screenshots other people have shared. You've never heard from Wren yourself. You're stuck weighing an account from someone you can't actually question.",
        ],
      },
      {
        id: "accounts-p2",
      ...
      },
      {
        ...
        body: [
          "Here's the actual trap: writing a full reasoning chain for an IDENTIFY part wastes your time without earning extra credit — the point is already earned the moment you name the right specific thing. And writing just a bare fact for an EXPLAIN part loses you the point entirely, even if the fact you named is completely accurate — naming isn't explaining.",
          "You're about to get two separate real SAQ-style parts, graded one at a time — first an identify/describe part, then an explain part — so you can feel the different demand of each, instead of blurring them together.",
        ],
      },
      {
        id: "accounts-p4",
        ...
        body: [
          "First part: the Song Dynasty's civil service examination system — how a bureaucracy actually gets built and staffed. Second part: a comparison between two other major Unit 1 state-building stories, so you're not stuck on one topic the whole module.",
          "Same self-diagnosis heads-up as before: before Scout shows you feedback, you'll get a beat to name your own weakest spot first. Take it if you can.",
        ],
      },
      {
    ...
    pages: [
      {
        ...
        body: [
          "Here's the honest truth about Marisol: this never resolves into one clean, provable answer. Devon's story checked out. Priya was hiding something real, but it doesn't actually prove she did anything to Marisol beyond keeping a secret. Jonah and Devon still don't fully agree. Wren's texts add a little more, but you never got to ask Wren anything directly.",
          "Before you move on, take a second — no writing required, just think it through — and land on your own verdict: what do YOU think actually happened, and which piece of evidence matters most to you? This is the last time the story shows up as content. From here on, it's pure warm-up before the real thing.",
        ],
      },
      {
        id: "verdict-p2",
        ...
        body: [
          "What's coming next is a genuine, full 3-part AP World SAQ — the actual format, the actual rigor, graded on the real rubric. No given context, no stimulus training wheels, no isolated single-move drills. All three parts, back to back, exactly like the real exam.",
          "Untimed, and you can revise as many times as you need to clear it — this is the one place in the whole course where there's no rush. Take the time to actually think through each part before you write.",
        ],
      },
      {
        id: "verdict-p3",
        ...
        body: [
          "Same as before: right after you submit, Scout will ask what you think the weakest part of your response is before showing any feedback. This is the last self-diagnosis check in the course — a genuinely good habit to walk away with, exam day and beyond.",
        ],
      },
      {
        id: "verdict-full-saq",
